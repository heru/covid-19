<template>
  ...
  >
    <v-row dense>
      <v-col cols="12">
        <v-card>
          <v-card-title>Informasi Situs Ini</v-card-title>
          <v-card-text>
            Ini adalah unofficial Covid Map Kabupaten Tulungagung & Trenggalek. 
            Data Diperoleh dari website resmi covid-19 dari kedua wilayah tersebut
          </v-card-text>
          <v-card-subtitle>Data Sebaran Covid-19</v-card-subtitle>
          <v-card-text>
